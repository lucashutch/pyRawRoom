...
def test_mouse_move_event_hover(star_rating_widget, qtbot):
    ...
    event = QtGui.QMouseEvent(QtCore.QEvent.MouseMove, QtCore.QPoint(x_pos, 5),
    ...
    event = QtGui.QMouseEvent(QtCore.QEvent.MouseMove, QtCore.QPoint(0, 5),
                              QtCore.Qt.NoButton, QtCore.Qt.NoButton, QtCore.Qt.NoModifier)
    QtWidgets.QApplication.sendEvent(star_rating_widget, event)
    qtbot.wait(10)
...
def test_mouse_leave_event(star_rating_widget, qtbot):
    ...
    event_move = QtGui.QMouseEvent(QtCore.QEvent.MouseMove, QtCore.QPoint(star_width * 2, 5),
                                   QtCore.Qt.NoButton, QtCore.Qt.NoButton, QtCore.Qt.NoModifier)
    ...
    event_leave = QtGui.QMouseEvent(QtCore.QEvent.Leave, QtCore.QPoint(-1, -1), # Coordinates don't matter much for Leave
                                    QtCore.Qt.NoButton, QtCore.Qt.NoButton, QtCore.Qt.NoModifier)
...
def test_mouse_press_event_set_rating(star_rating_widget, qtbot):
    ...
    event_move = QtGui.QMouseEvent(QtCore.QEvent.MouseMove, QtCore.QPoint(x_pos, 5),
                                   QtCore.Qt.NoButton, QtCore.Qt.NoButton, QtCore.Qt.NoModifier)
    QtWidgets.QApplication.sendEvent(star_rating_widget, event_move)
    ...
    with qtbot.waitSignal(star_rating_widget.ratingChanged) as blocker:
        event_press = QtGui.QMouseEvent(QtCore.QEvent.MouseButtonPress, QtCore.QPoint(x_pos, 5),
                                        QtCore.Qt.LeftButton, QtCore.Qt.LeftButton, QtCore.Qt.NoModifier)
        QtWidgets.QApplication.sendEvent(star_rating_widget, event_press)
        qtbot.wait(10) # Give event loop a moment

        event_release = QtGui.QMouseEvent(QtCore.QEvent.MouseButtonRelease, QtCore.QPoint(x_pos, 5),
